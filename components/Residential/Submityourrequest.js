    ...
    return (
        <>
            <div className="mt-tabs bg-tabs">
                <ul className="nav nav-tabs m-l300">
                    <li className="active" style={{"cursor":"pointer"}}><a data-toggle="" href="#requestsubmit">Submit Your Request</a>
                    </li>
                    <li><a data-toggle="" href="#howitworks">How it works</a>
                    </li>
                    <li><a data-toggle="" href="#portfolio">Portfolio</a>
                    </li>
                    <li><a data-toggle="" href="#whychoose">Why Choose Us</a>
                    </li>
                </ul>
            </div>
