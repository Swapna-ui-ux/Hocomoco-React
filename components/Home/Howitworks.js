                            ...
                            <div className="col-md-3 col-sm-6 how-works">
                                <div className="mt-icon-box-wraper m-b30">
                                    <div className="relative icon-count-2 p-t30"> <span className="icon-count-number p-l50 p-r20">1</span>
                                        <div className="icon-md inline-icon m-b15 p-l40 p-r30 text-primary scale-in-center"> <span className="icon-cell"><img src="https://www.hocomoco.in/new-assets/images/icon/requirement1.png" alt=""/></span> </div>
                            ...
                            <div className="col-md-3 col-sm-6 how-works">
                                <div className="mt-icon-box-wraper m-b30">
                                    <div className="relative icon-count-2 p-t30"> <span className="icon-count-number p-l50 p-r20">2</span>
                                        <div className="icon-md inline-icon m-b15 p-l40 p-r30 text-primary scale-in-center"> <span className="icon-cell"><img src="https://www.hocomoco.in/new-assets/images/icon/costestimate1.png" alt=""/></span> </div>
                            ...
                            <div className="col-md-3 col-sm-6 how-works">
                                <div className="mt-icon-box-wraper m-b30">
                                    <div className="relative icon-count-2 p-t30"> <span className="icon-count-number  p-l50 p-r20">3</span>
                                        <div className="icon-md inline-icon m-b15 p-l40 p-r30 text-primary scale-in-center"> <span className="icon-cell"><img src="https://www.hocomoco.in/new-assets/images/icon/schedule1.png" alt=""/></span> </div>
                                        <div className="icon-content center p-t10 p-b0 p-l10 p-r10">
                            ...
                            <div className="col-md-3 col-sm-6 how-works">
                                <div className="mt-icon-box-wraper m-b30">
                                    <div className="relative icon-count-2 p-t30"> <span className="icon-count-number  p-l50 p-r20">4</span>
                                        <div className="icon-md inline-icon m-b15 p-l40 p-r30 text-primary scale-in-center"> <span className="icon-cell"><img src="https://www.hocomoco.in/new-assets/images/icon/excute1.png" alt=""/></span> </div>
                                        <div className="icon-content p-t10 p-b0 p-l10 p-r10">
                            ...
                            <div className="col-md-3 col-sm-6 how-works">
                                <div className="mt-icon-box-wraper m-b30">
                                    <div className="relative icon-count-2 p-t30"> <span className="icon-count-number  p-l50 p-r20">5</span>
                                        <div className="icon-md inline-icon m-b15 p-l40 p-r30 text-primary scale-in-center"> <span className="icon-cell"><img src="https://www.hocomoco.in/new-assets/images/icon/architecture1.png" alt=""/></span> </div>
                                        <div className="icon-content p-t10 p-b0 p-l10 p-r10">
