! function(e) {
    ...
    jQuery(document).ready(function() {
        jQuery('a[href="#search"]').on("click", function(e) {
        ...
        })), t(), e(".acod-head a").on("click", function() {
        ...
        }), jQuery(".sub-menu").parent("li").addClass("has-child"), jQuery(".mega-menu").parent("li").addClass("has-child"), jQuery("<div class='fa fa-close submenu-toogle'>hocomoco-construction-services-navigation----------------------------------------------------------------------------------------------------------------------------------------------------------------------</div>").insertAfter(".has-child > a"), jQuery(".has-child a+.submenu-toogle").on("click", function(e) {
            ...
            items: 1,
            dots: !0
        }), e(".input input , .input textarea").focus(function() {
            e(this).parent(".input").each(function() {
                e("label", this).css({
                    "line-height": "18px",
                    "font-size": "12px",
                    "font-weight": "500",
            ...
            e(".spin").css({
                width: "0px"
            }), "" == e(this).val() && e(this).parent(".input").each(function() {
                e("label", this).css({
                    "line-height": "40px",
                    "font-size": "12px",
                    "font-weight": "500",
        ...
        a(".equal-wraper .equal-col"),
            ...
            (), e(".loading-area").fadeOut(1e3), jQuery(".work-carousel").owlCarousel({
                loop: !0,
                autoplay: !1,
                center: !1,
                items: 3,
        ...
        }), jQuery(".cons-contact-form").trigger("reset"), !1
        ...
        return jQuery.ajax({
            ...
            success: function(e) {
                jQuery(".loading-area").hide(), e.success ? jQuery("<div class='alert alert-success'>" + e.message + "</div>").insertBefore("form.cons-contact-form2") : jQuery("<div class='alert alert-danger'>" + e.message + "</div>").insertBefore("form.cons-contact-form2")
            }
        }), jQuery(".cons-contact-form2").trigger("reset"), !1
    })
}(window.jQuery);
